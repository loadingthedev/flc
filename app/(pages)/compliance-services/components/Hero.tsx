...
export default function Hero() {
  ...
  useEffect(() => {
    fetch("/api/complaince-services/hero")
      .then((res) => res.json())
    ...
    >
      ...
      >
        ...
        <p
          className="
          text-white mb-6
          text-sm sm:text-base md:text-xl lg:text-2xl xl:text-3xl leading-relaxed
        "
        >
      ...
      <div
        ...
        md:pl-10 md:pt-12 lg:pt-20 flex justify-center items-center
      "
      >
        <img
          src="https://virtuzone.com/wp-content/uploads/2022/02/Compliance-Services.png.webp"
          alt="UAE Free Zone"
          className="
            w-full h-auto
