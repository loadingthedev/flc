...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row md:items-center sm:items-center md:mt-20 ">
      <div className="mt-8 md:mt-0 w-full">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center mt-8">
          ...
          <div className="md:w-1/2 w-full mt-8  md:pl-10 px-4 md:text-justify md:text-left">
            <p className="text-lg">
