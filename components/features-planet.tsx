    ...
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Grid */}
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
            {[
              {
                title: "Fundraise",
                description:
                  "Choose the right documents, set up entities in the best jurisdictions, and comply with KYC & AML.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Choose the best location, evaluate local regulations, and set up legal entities.",
                icon: (
                  <svg
                    className="fill-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Set up a token issuance entity, obtain token legal opinion, prepare a launch strategy, and comply with regulations.",
                icon: (
                  <svg
                    className="fill-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Set up an entity for your product launch, prepare documents and comply with privacy, AI, and consumer protection rules.",
                icon: (
                  <svg
                    className="fill-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {
                title: "Launch a protocol",
                description:
                  "Choose the best legal setup for the launch, and apply the progressive decentralization framework.",
                icon: (
                  <svg
                    className="fill-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                title: "Wrap a DAO",
                description:
                  "Set up a DAO company and prepare the DAO governance and constitution.",
                icon: (
                  <svg
                    className="fill-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <article
                key={index}
                className="relative p-6 md:p-10 before:absolute before:bg-gray-800 before:block before:h-full before:w-px before:inset-y-0 before:left-0 after:absolute after:bg-gray-800 after:h-px after:w-full after:inset-x-0 after:top-0 transition-transform duration-300 hover:scale-105 hover:shadow-lg"
              >
