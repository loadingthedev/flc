          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Choose the right documents, set up entities in the best
                jurisdictions, and comply with KYC & AML.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Choose the best location, evaluate local regulations, and set up
                legal entities.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Set up a token issuance entity, obtain token legal opinion,
                prepare a launch strategy, and comply with regulations
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Set up an entity for your product launch, prepare documents and
                comply with privacy, AI, and consumer protection rules.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Launch a protocol</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Choose the best legal setup for the launch, and apply the
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Wrap a DAO</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Set up a DAO company and prepare the DAO governance and
                constitution.
              </p>
            </article>
          </div>
